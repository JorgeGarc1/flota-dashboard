          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="relative my-6">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-flota-secondary/20"></div>
              </div>
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-black/40 px-2 text-flota-text">O continuar con</span>
              </div>
            </div>
            ...
            <Button 
              ...
              className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold flex items-center justify-center gap-2"
            >
